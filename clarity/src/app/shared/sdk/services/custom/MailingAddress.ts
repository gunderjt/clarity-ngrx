...
/**
 * Api services for the `MailingAddress` model.
 */
@Injectable()
export class MailingAddressApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `MailingAddress` object.)
   * </em>
   */
  public getPerson(id: any, refresh: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MailingAddresses/:id/person";
